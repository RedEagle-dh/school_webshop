...
<body data-menu="vertical-menu" class="vertical-layout vertical-menu content-right-sidebar menu-expanded">
    ...
    <section class="section">
        <div class="container">
            <div class="content-area col-md-8 mx-auto">
                <div class="site-content">
                    <article class="post-108 page type-page status-publish hentry">
                        <header class="entry-header">
                            <h1 class="entry-title goingdark">Allgemeine Geschäftsbedingungen</h1>
                        </header>
                        <div class="entry-content goingdark">
                            <p>Nachfolgend finden Sie unsere Allgemeinen Geschäftsbedingungen, die eine Menge rechtlicher Details enthalten, aber unser Ziel ist es, uns immer um Sie als Kunde oder als Verkäufer auf unserer Plattform zu kümmern.
                                Wir haben viele dieser Bedingungen aufgenommen, um uns rechtlich abzusichern, aber wenn Sie ein Problem haben, können Sie uns jederzeit eine E-Mail an david.hermann2003@gmail.com schicken, und wir werden unser Bestes tun, um es auf faire und zeitnahe Weise zu lösen.</p>
                            <ol>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ol>
                                        <li>
                                            Der Kaufvertrag kommt zustande mit Dave's Webshop e.K., Inhaber: David Hermann, Rheinstr. 20, 36124 Eichenzell, Handelsregister: Amtsgericht Kassel, HRA 12345.
                                        </li>
                                    </ol>
                                </li>
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>Durch Anklicken des Buttons [Kaufen/kostenpflichtig bestellen] geben Sie eine verbindliche Bestellung der auf der Bestellseite aufgelisteten Waren ab. Ihr Kaufvertrag kommt zustande, wenn wir Ihre Bestellung durch eine Auftragsbestätigung per E-Mail unmittelbar nach dem Erhalt Ihrer Bestellung annehmen.</li>
                                    </ol>
                                </li>
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>Machen Sie als Verbraucher von Ihrem Widerrufsrecht nach Ziffer 4.1 Gebrauch, so haben Sie die regelmäßigen Kosten der Rücksendung zu tragen.</li>
                                        <li>
                                            Im Übrigen gelten für das Widerrufsrecht die Regelungen, die im Einzelnen wiedergegeben sind in der folgenden <br><br>
                                        </li>
                                        <strong>
                                ...
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>Zusätzlich zu den angegebenen Preisen berechnen wir für die Lieferung innerhalb Deutschlands einen gewissen Betrag Produkt. Die Versandkosten werden Ihnen auf den Produktseiten, im Warenkorbsystem und auf der Bestellseite nochmals deutlich mitgeteilt.</li>
                                    </ol>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ol>
                                        <li>
                                            Die Zahlung erfolgt wahlweise per PayPal oder Kredit/Debitkarte.
                                        </li>
                                    </ol>
                                </li>
                                <li>
