                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwoo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded searchbar">
                            ...
                            <a class="collapse-item active goingdark" href="index.php/removecategory">Entfernen</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column adminback">
                        ...
                        <div class="fade active show">
                            <div class="container-fluid">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 text-gray-800 goingdark">Kategorien Entfernen</h1>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-lg-7">
                                            <div class="card shadow mb-4 darkcard row-border-light">
                                                ...
                                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between  darkcard row-border-light">
                                                    <h6 class="m-0 font-weight-bold text-success">Kategorienliste</h6>
                                        ...
                                        <div class="col-xl-4 col-lg-5">
                                            <div class="card shadow mb-4 darkcard row-border-light">
                                                <!-- Card Header - Dropdown -->
                                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between  darkcard row-border-light">
                                                    <h6 class="m-0 font-weight-bold text-primary">Kategorienauswahl</h6>
                                                    <div class="dropdown no-arrow">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-md-12 mb-4 pb-2 mb-md-0 pb-md-0">
                                                        <p id="anzahlhaken">0 Kategorien ausgewählt</p>
                ...
                <script>
                    ...
                    function removeProductsOnButtonClick(message) {
                        ...
                        if (message.trim() === "0 Kategorien ausgewählt".trim()) {
                            ...
                            ajax.open("GET", "templates/ajax.php?removecatid=" + ids + "&catid=" + pids, true);
                            ajax.send();
                            ajax.onreadystatechange = function() {
                                if (this.readyState == 4 && this.status == 200) {
                                    ...
                                    document.getElementById("anzahlhaken").textContent = "0 Kategorien ausgewählt";
                                }
                    ...
                    function hakenAusgewaehlt(message) {
                        ...
                        ajax.onreadystatechange = function() {
                            if (this.readyState == 4 && this.status == 200) {
                                var msg = "";
                                if (this.response == 1) {
                                    msg = " Kategorie ausgewählt";
                                } else if (this.response > 1) {
                                    msg = " Kategorien ausgewählt";
                                } else {
                                    msg = " Kategorien ausgewählt";
                                }
                                document.getElementById("anzahlhaken").textContent = this.response + msg;
                                if (this.response == 0) {
